...
│ :8001        │ :8002        │ :8004        │  :8080                │
├──────────────┬──────────────┴──────────────┤                       │
│ ai-builder-gpu（可选, profile: gpu-build） │                       │
│ (GPU 编译, :8007 -> 8004)                  │                       │
├──────────────┴──────────────┴──────────────┤                       │
│                                            │  ai-license-mgr       │
...
| 5 | `agilestar/ai-builder-linux-x86` | `build/Dockerfile.linux_x86` | `ubuntu:22.04` | 8004 | C++ x86_64 CPU/ORT 编译 |
| 6 | `agilestar/ai-builder-linux-x86-gpu` | `build/Dockerfile.linux_x86_gpu` | `nvidia/cuda:11.8.0-cudnn8-devel-ubuntu22.04` | 8007 | C++ x86_64 GPU 编译（CUDA Toolkit + TensorRT dev） |
| 7 | `agilestar/ai-builder-linux-arm` | `build/Dockerfile.linux_arm` | `ubuntu:22.04` | 8004 | C++ aarch64 编译 |
| 8 | `agilestar/ai-builder-windows` | `build/Dockerfile.windows` | `ubuntu:22.04` | 8004 | Windows x86_64 交叉编译 |
| 9 | `agilestar/ai-prod` | `prod/Dockerfile` | `ubuntu:22.04` | 8080 | 生产 AI 推理服务 |
