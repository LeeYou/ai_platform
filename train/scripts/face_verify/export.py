"""Export face_verify (人脸认证比对（1:1比对）) model to ONNX format.

Usage:
    python export.py --output /workspace/models/face_verify/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export face_verify to ONNX")
...
def main():
    ...
    # TODO: replace with real ArcFace+ResNet50 model class
