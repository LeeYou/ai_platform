"""Export entity_link (知识图谱实体链接) model to ONNX format.

Usage:
    python export.py --output /workspace/models/entity_link/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export entity_link to ONNX")
...
def main():
    ...
    # TODO: replace with real ELMo/BERT+知识库 model class
