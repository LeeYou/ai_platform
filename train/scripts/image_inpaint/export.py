"""Export image_inpaint (图像修复) model to ONNX format.

Usage:
    python export.py --output /workspace/models/image_inpaint/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export image_inpaint to ONNX")
...
def main():
    ...
    # TODO: replace with real LaMa/DeepFill model class
