"""Export contract_seal_detect (合同印章检测) model to ONNX format.

Usage:
    python export.py --output /workspace/models/contract_seal_detect/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export contract_seal_detect to ONNX")
...
def _write_labels_json(output_path: str) -> None:
    data = {"labels": ['round_seal', 'oval_seal', 'square_seal', 'fingerprint'], "num_classes": 4}
...
def main():
    ...
    # TODO: replace with real YOLOv8n model class
