"""Train sensitive_detect (敏感信息识别（涉政/色情/暴恐）).

Architecture: RoBERTa+多标签分类
...
def _parse_args():
    p = argparse.ArgumentParser(description="Train sensitive_detect")
    p.add_argument("--config",  default="config.json")
    p.add_argument("--dataset", default="/workspace/datasets/sensitive_detect/")
...
def _build_model(device):
    """TODO: Replace with the real RoBERTa+多标签分类 model."""
...
def main():
    ...
    print(f"[INFO] Starting training: sensitive_detect v{args.version}", flush=True)
