"""Export eseal_verify (电子签章真伪校验) model to ONNX format.

Usage:
    python export.py --output /workspace/models/eseal_verify/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export eseal_verify to ONNX")
...
def _write_labels_json(output_path: str) -> None:
    data = {"labels": ['genuine', 'fake'], "num_classes": 2}
...
def main():
    ...
    # TODO: replace with real EfficientNet-B2+特征比对 model class
