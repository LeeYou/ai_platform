"""Export slot_fill (槽位填充) model to ONNX format.

Usage:
    python export.py --output /workspace/models/slot_fill/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export slot_fill to ONNX")
...
def main():
    ...
    # TODO: replace with real BERT-CRF model class
