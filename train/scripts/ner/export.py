"""Export ner (命名实体识别（人名/地名/机构名）) model to ONNX format.

Usage:
    python export.py --output /workspace/models/ner/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export ner to ONNX")
...
def _write_labels_json(output_path: str) -> None:
    data = {"labels": ['PER', 'LOC', 'ORG', 'TIME', 'NUM'], "num_classes": 5}
...
def main():
    ...
    # TODO: replace with real BERT-CRF/RoBERTa-large model class
