"""Export social_security_ocr (社保卡识别) model to ONNX format.

Usage:
    python export.py --output /workspace/models/social_security_ocr/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export social_security_ocr to ONNX")
