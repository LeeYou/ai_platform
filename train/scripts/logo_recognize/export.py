"""Export logo_recognize (商标Logo识别) model to ONNX format.

Usage:
    python export.py --output /workspace/models/logo_recognize/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export logo_recognize to ONNX")
...
def main():
    ...
    # TODO: replace with real EfficientNet-B3+ArcFace model class
