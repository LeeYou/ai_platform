"""Export vocal_separate (人声分离) model to ONNX format.

Usage:
    python export.py --output /workspace/models/vocal_separate/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export vocal_separate to ONNX")
...
def main():
    ...
    # TODO: replace with real Demucs/Conv-TasNet model class
