"""Export ocr_table (表格识别与结构化提取) model to ONNX format.

Usage:
    python export.py --output /workspace/models/ocr_table/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export ocr_table to ONNX")
...
def main():
    ...
    # TODO: replace with real TableFormer/LORE model class
