"""Export face_liveness_action (指令活体检测（唇语/动作）) model to ONNX format.

Usage:
    python export.py --output /workspace/models/face_liveness_action/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export face_liveness_action to ONNX")
...
def _write_labels_json(output_path: str) -> None:
    data = {"labels": ['blink', 'open_mouth', 'nod', 'turn_head'], "num_classes": 4}
...
def main():
    ...
    # TODO: replace with real LSTM+CNN/MediaPipe model class
