"""Export plate_recognize (车牌识别) model to ONNX format.

Usage:
    python export.py --output /workspace/models/plate_recognize/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export plate_recognize to ONNX")
...
def _write_preprocess_json(output_path: str) -> None:
    data = {
        "resize": {"width": 94, "height": 24, "keep_ratio": True},
...
def main():
    ...
    # TODO: replace with real LPRNet/YOLOv8+CRNN model class
