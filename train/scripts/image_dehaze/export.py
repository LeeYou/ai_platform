"""Export image_dehaze (图像去雾) model to ONNX format.

Usage:
    python export.py --output /workspace/models/image_dehaze/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export image_dehaze to ONNX")
...
def main():
    ...
    # TODO: replace with real AOD-Net/MSBDN model class
