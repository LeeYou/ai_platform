"""Export watermark_extract (图像水印提取/去除) model to ONNX format.

Usage:
    python export.py --output /workspace/models/watermark_extract/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export watermark_extract to ONNX")
...
def main():
    ...
    # TODO: replace with real DWT+CNN/WDNet model class
