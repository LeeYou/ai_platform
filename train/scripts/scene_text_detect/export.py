"""Export scene_text_detect (场景文字检测) model to ONNX format.

Usage:
    python export.py --output /workspace/models/scene_text_detect/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export scene_text_detect to ONNX")
...
def _write_labels_json(output_path: str) -> None:
    data = {"labels": ['text'], "num_classes": 1}
...
def main():
    ...
    # TODO: replace with real DBNet/EAST model class
