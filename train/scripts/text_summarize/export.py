"""Export text_summarize (文本摘要) model to ONNX format.

Usage:
    python export.py --output /workspace/models/text_summarize/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export text_summarize to ONNX")
...
def main():
    ...
    # TODO: replace with real BART/ProphetNet model class
