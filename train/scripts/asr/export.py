"""Export asr (语音识别（ASR）) model to ONNX format.

Usage:
    python export.py --output /workspace/models/asr/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export asr to ONNX")
...
def main():
    ...
    # TODO: replace with real Whisper-small/Paraformer model class
