"""Export sentiment_analyze (情感分析) model to ONNX format.

Usage:
    python export.py --output /workspace/models/sentiment_analyze/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export sentiment_analyze to ONNX")
...
def _write_labels_json(output_path: str) -> None:
    data = {"labels": ['positive', 'neutral', 'negative'], "num_classes": 3}
...
def main():
    ...
    # TODO: replace with real RoBERTa-wwm model class
