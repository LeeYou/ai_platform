"""Export id_card_front_detect (身份证人像面检测) model to ONNX format.

Usage:
    python export.py --output /workspace/models/id_card_front_detect/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export id_card_front_detect to ONNX")
...
def _write_labels_json(output_path: str) -> None:
    data = {"labels": ['id_front'], "num_classes": 1}
