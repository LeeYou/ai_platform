"""Export face_swap (人脸融合（换脸）) model to ONNX format.

Usage:
    python export.py --output /workspace/models/face_swap/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export face_swap to ONNX")
...
def main():
    ...
    # TODO: replace with real SimSwap/FaceShifter model class
