"""Export text_classify (文本分类) model to ONNX format.

Usage:
    python export.py --output /workspace/models/text_classify/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export text_classify to ONNX")
...
def main():
    ...
    # TODO: replace with real BERT/TextCNN model class
