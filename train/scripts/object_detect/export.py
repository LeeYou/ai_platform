"""Export object_detect (目标检测（通用物体检测）) model to ONNX format.

Usage:
    python export.py --output /workspace/models/object_detect/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export object_detect to ONNX")
