"""Export product_recognize (商品识别) model to ONNX format.

Usage:
    python export.py --output /workspace/models/product_recognize/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export product_recognize to ONNX")
...
def main():
    ...
    # TODO: replace with real EfficientNet-B3 model class
