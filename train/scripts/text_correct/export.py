"""Export text_correct (文本纠错) model to ONNX format.

Usage:
    python export.py --output /workspace/models/text_correct/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export text_correct to ONNX")
...
def main():
    ...
    # TODO: replace with real MacBERT/SoftMaskedBERT model class
