"""Export face_landmark (人脸关键点检测) model to ONNX format.

Usage:
    python export.py --output /workspace/models/face_landmark/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export face_landmark to ONNX")
...
def main():
    ...
    # TODO: replace with real PFLD/HRNet-W18 model class
