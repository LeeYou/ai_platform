"""Export image_retrieval (图像相似度检索) model to ONNX format.

Usage:
    python export.py --output /workspace/models/image_retrieval/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export image_retrieval to ONNX")
...
def main():
    ...
    # TODO: replace with real ViT-B/16+CLIP model class
