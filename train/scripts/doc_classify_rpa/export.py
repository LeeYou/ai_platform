"""Export doc_classify_rpa (文档分类（RPA）) model to ONNX format.

Usage:
    python export.py --output /workspace/models/doc_classify_rpa/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export doc_classify_rpa to ONNX")
...
def main():
    ...
    # TODO: replace with real EfficientNet-B0+OCR特征 model class
