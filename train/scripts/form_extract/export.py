"""Export form_extract (表单信息抽取) model to ONNX format.

Usage:
    python export.py --output /workspace/models/form_extract/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export form_extract to ONNX")
...
def main():
    ...
    # TODO: replace with real LayoutLMv3/PP-Structure model class
