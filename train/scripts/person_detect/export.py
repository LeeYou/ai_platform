"""Export person_detect (人体检测) model to ONNX format.

Usage:
    python export.py --output /workspace/models/person_detect/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export person_detect to ONNX")
...
def _write_labels_json(output_path: str) -> None:
    data = {"labels": ['person'], "num_classes": 1}
