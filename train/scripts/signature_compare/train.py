"""Train signature_compare (手写签名比对).

Architecture: Siamese-CNN/SigNet
...
def _parse_args():
    p = argparse.ArgumentParser(description="Train signature_compare")
    p.add_argument("--config",  default="config.json")
    p.add_argument("--dataset", default="/workspace/datasets/signature_compare/")
...
def _build_model(device):
    """TODO: Replace with the real Siamese-CNN/SigNet model."""
...
def main():
    ...
    print(f"[INFO] Starting training: signature_compare v{args.version}", flush=True)
