"""Export hk_macao_permit_ocr (港澳台通行证识别) model to ONNX format.

Usage:
    python export.py --output /workspace/models/hk_macao_permit_ocr/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export hk_macao_permit_ocr to ONNX")
...
def _write_preprocess_json(output_path: str) -> None:
    data = {
        "resize": {"width": 640, "height": 400, "keep_ratio": True},
...
def main():
    ...
    # TODO: replace with real PP-OCRv4+KIE model class
