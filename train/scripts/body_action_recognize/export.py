"""Export body_action_recognize (肢体动作识别) model to ONNX format.

Usage:
    python export.py --output /workspace/models/body_action_recognize/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export body_action_recognize to ONNX")
    p.add_argument("--output",     default="/workspace/models/body_action_recognize/v1.0.0/")
...
def _write_labels_json(output_path: str) -> None:
    data = {"labels": ['stand', 'sit', 'walk', 'wave', 'clap'], "num_classes": 5}
...
def main():
    ...
    # TODO: replace with real ST-GCN/PoseC3D model class
