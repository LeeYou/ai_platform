"""Export face_3d_reconstruct (3D人脸重建) model to ONNX format.

Usage:
    python export.py --output /workspace/models/face_3d_reconstruct/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export face_3d_reconstruct to ONNX")
...
def main():
    ...
    # TODO: replace with real 3DDFA_V2/Deep3DFace model class
