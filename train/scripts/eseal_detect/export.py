"""Export eseal_detect (电子签章检测) model to ONNX format.

Usage:
    python export.py --output /workspace/models/eseal_detect/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export eseal_detect to ONNX")
...
def _write_labels_json(output_path: str) -> None:
    data = {"labels": ['eseal'], "num_classes": 1}
