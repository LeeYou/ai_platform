"""Export face_beautify (人脸美颜/美型) model to ONNX format.

Usage:
    python export.py --output /workspace/models/face_beautify/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export face_beautify to ONNX")
...
def main():
    ...
    # TODO: replace with real UNET/Pix2Pix model class
