"""Export ocr_driver_license (驾驶证识别) model to ONNX format.

Usage:
    python export.py --output /workspace/models/ocr_driver_license/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export ocr_driver_license to ONNX")
