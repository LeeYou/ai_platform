"""Export image_tamper_detect (图像篡改检测) model to ONNX format.

Usage:
    python export.py --output /workspace/models/image_tamper_detect/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export image_tamper_detect to ONNX")
...
def _write_preprocess_json(output_path: str) -> None:
    data = {
        "resize": {"width": 512, "height": 512, "keep_ratio": True},
...
def main():
    ...
    # TODO: replace with real MantraNet/MVSS-Net model class
