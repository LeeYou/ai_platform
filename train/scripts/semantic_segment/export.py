"""Export semantic_segment (图像语义分割) model to ONNX format.

Usage:
    python export.py --output /workspace/models/semantic_segment/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export semantic_segment to ONNX")
...
def main():
    ...
    # TODO: replace with real DeepLabV3+/SegFormer model class
