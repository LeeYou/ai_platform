"""Export person_reid (行人重识别（Person ReID）) model to ONNX format.

Usage:
    python export.py --output /workspace/models/person_reid/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export person_reid to ONNX")
...
def _write_preprocess_json(output_path: str) -> None:
    data = {
        "resize": {"width": 128, "height": 256, "keep_ratio": True},
...
def main():
    ...
    # TODO: replace with real OSNet/TransReID model class
