"""Export contract_party (合同甲方乙方识别) model to ONNX format.

Usage:
    python export.py --output /workspace/models/contract_party/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export contract_party to ONNX")
