"""Export face_recognition (人脸识别（1:N检索）) model to ONNX format.

Usage:
    python export.py --output /workspace/models/face_recognition/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export face_recognition to ONNX")
...
def main():
    ...
    # TODO: replace with real ArcFace/CosFace+ResNet50 model class
