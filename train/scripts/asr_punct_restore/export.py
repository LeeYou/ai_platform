"""Export asr_punct_restore (语音转写标点恢复) model to ONNX format.

Usage:
    python export.py --output /workspace/models/asr_punct_restore/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export asr_punct_restore to ONNX")
...
def main():
    ...
    # TODO: replace with real BERT+CRF/CT-Transformer model class
