"""Export doc_rectify (文档矫正（倾斜文档自动摆正）) model to ONNX format.

Usage:
    python export.py --output /workspace/models/doc_rectify/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export doc_rectify to ONNX")
...
def main():
    ...
    # TODO: replace with real DocTr/MORAN model class
