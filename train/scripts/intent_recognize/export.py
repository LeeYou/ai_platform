"""Export intent_recognize (意图识别) model to ONNX format.

Usage:
    python export.py --output /workspace/models/intent_recognize/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export intent_recognize to ONNX")
...
def main():
    ...
    # TODO: replace with real BERT+分类头 model class
