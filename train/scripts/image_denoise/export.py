"""Export image_denoise (图像去噪) model to ONNX format.

Usage:
    python export.py --output /workspace/models/image_denoise/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export image_denoise to ONNX")
...
def main():
    ...
    # TODO: replace with real DnCNN/NAFNet model class
