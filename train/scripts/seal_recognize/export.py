"""Export seal_recognize (印章识别与提取) model to ONNX format.

Usage:
    python export.py --output /workspace/models/seal_recognize/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export seal_recognize to ONNX")
...
def _write_labels_json(output_path: str) -> None:
    data = {"labels": ['seal_round', 'seal_oval', 'seal_square'], "num_classes": 3}
...
def main():
    ...
    # TODO: replace with real YOLOv8n+分类头 model class
