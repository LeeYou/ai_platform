"""Export passport_cn_ocr (中国护照识别) model to ONNX format.

Usage:
    python export.py --output /workspace/models/passport_cn_ocr/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export passport_cn_ocr to ONNX")
