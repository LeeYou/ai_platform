"""Train audio_fingerprint (音频指纹检索).
...
def _parse_args():
    p = argparse.ArgumentParser(description="Train audio_fingerprint")
    p.add_argument("--config",  default="config.json")
    p.add_argument("--dataset", default="/workspace/datasets/audio_fingerprint/")
...
def _build_model(device):
    """TODO: Replace with the real CNN+triplet loss model."""
...
def main():
    ...
    print(f"[INFO] Starting training: audio_fingerprint v{args.version}", flush=True)
