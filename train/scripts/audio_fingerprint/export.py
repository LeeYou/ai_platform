"""Export audio_fingerprint (音频指纹检索) model to ONNX format.

Usage:
    python export.py --output /workspace/models/audio_fingerprint/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export audio_fingerprint to ONNX")
    p.add_argument("--output",     default="/workspace/models/audio_fingerprint/v1.0.0/")
...
def main():
    ...
    # TODO: replace with real CNN+triplet loss model class
