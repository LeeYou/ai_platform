"""Export action_recognize (行为识别（摔倒/奔跑/打架等）) model to ONNX format.

Usage:
    python export.py --output /workspace/models/action_recognize/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export action_recognize to ONNX")
...
def _write_labels_json(output_path: str) -> None:
    data = {"labels": ['normal', 'fall', 'run', 'fight', 'crowd'], "num_classes": 5}
...
def main():
    ...
    # TODO: replace with real SlowFast/VideoSwin model class
