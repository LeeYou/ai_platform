"""Export household_register_ocr (户口本识别) model to ONNX format.

Usage:
    python export.py --output /workspace/models/household_register_ocr/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export household_register_ocr to ONNX")
