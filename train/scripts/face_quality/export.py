"""Export face_quality (人脸质量评估) model to ONNX format.

Usage:
    python export.py --output /workspace/models/face_quality/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export face_quality to ONNX")
...
def main():
    ...
    # TODO: replace with real MobileNetV2 regression model class
