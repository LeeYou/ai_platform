"""Export instance_segment (实例分割) model to ONNX format.

Usage:
    python export.py --output /workspace/models/instance_segment/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export instance_segment to ONNX")
...
def main():
    ...
    # TODO: replace with real Mask R-CNN/YOLOv8-seg model class
