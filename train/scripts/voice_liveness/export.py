"""Export voice_liveness (语音活体检测) model to ONNX format.

Usage:
    python export.py --output /workspace/models/voice_liveness/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export voice_liveness to ONNX")
...
def main():
    ...
    # TODO: replace with real AASIST/RawBoost model class
