"""Export contract_summary (合同摘要提取) model to ONNX format.

Usage:
    python export.py --output /workspace/models/contract_summary/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export contract_summary to ONNX")
    p.add_argument("--output",     default="/workspace/models/contract_summary/v1.0.0/")
...
def main():
    ...
    # TODO: replace with real BART/ProphetNet-CG model class
