"""Train contract_summary (合同摘要提取).

Architecture: BART/ProphetNet-CG
...
def _parse_args():
    p = argparse.ArgumentParser(description="Train contract_summary")
    p.add_argument("--config",  default="config.json")
    p.add_argument("--dataset", default="/workspace/datasets/contract_summary/")
...
def _build_model(device):
    """TODO: Replace with the real BART/ProphetNet-CG model."""
...
def main():
    ...
    print(f"[INFO] Starting training: contract_summary v{args.version}", flush=True)
