"""Export panoptic_segment (全景分割) model to ONNX format.

Usage:
    python export.py --output /workspace/models/panoptic_segment/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export panoptic_segment to ONNX")
...
def main():
    ...
    # TODO: replace with real Panoptic-FPN/Mask2Former model class
