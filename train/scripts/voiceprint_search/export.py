"""Export voiceprint_search (声纹检索（1:N检索）) model to ONNX format.

Usage:
    python export.py --output /workspace/models/voiceprint_search/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export voiceprint_search to ONNX")
    p.add_argument("--output",     default="/workspace/models/voiceprint_search/v1.0.0/")
...
def main():
    ...
    # TODO: replace with real ECAPA-TDNN model class
