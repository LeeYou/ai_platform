"""Export bill_verify (票据验真) model to ONNX format.

Usage:
    python export.py --output /workspace/models/bill_verify/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export bill_verify to ONNX")
...
def main():
    ...
    # TODO: replace with real CNN+特征检测 model class
