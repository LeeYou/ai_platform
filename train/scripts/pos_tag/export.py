"""Export pos_tag (词性标注) model to ONNX format.

Usage:
    python export.py --output /workspace/models/pos_tag/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export pos_tag to ONNX")
...
def main():
    ...
    # TODO: replace with real BERT-CRF/LTP model class
