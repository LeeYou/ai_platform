"""Export text_similarity (文本相似度计算) model to ONNX format.

Usage:
    python export.py --output /workspace/models/text_similarity/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export text_similarity to ONNX")
...
def main():
    ...
    # TODO: replace with real SimCSE/BGE model class
