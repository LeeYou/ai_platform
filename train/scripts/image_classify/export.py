"""Export image_classify (图像分类) model to ONNX format.

Usage:
    python export.py --output /workspace/models/image_classify/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export image_classify to ONNX")
...
def main():
    ...
    # TODO: replace with real EfficientNet-B0/ResNet50 model class
