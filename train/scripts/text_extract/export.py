"""Export text_extract (文本结构化抽取（合同/公文）) model to ONNX format.

Usage:
    python export.py --output /workspace/models/text_extract/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export text_extract to ONNX")
...
def main():
    ...
    # TODO: replace with real LayoutLMv3/BERT+UIE model class
