"""Export ocr_handwriting (手写体OCR) model to ONNX format.

Usage:
    python export.py --output /workspace/models/ocr_handwriting/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export ocr_handwriting to ONNX")
...
def _write_preprocess_json(output_path: str) -> None:
    data = {
        "resize": {"width": 320, "height": 32, "keep_ratio": True},
...
def main():
    ...
    # TODO: replace with real TrOCR/CRNN model class
