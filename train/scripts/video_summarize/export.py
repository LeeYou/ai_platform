"""Export video_summarize (视频摘要) model to ONNX format.

Usage:
    python export.py --output /workspace/models/video_summarize/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export video_summarize to ONNX")
...
def main():
    ...
    # TODO: replace with real CLIP+TextRank model class
