"""Export voiceprint_verify (声纹识别（1:1比对）) model to ONNX format.

Usage:
    python export.py --output /workspace/models/voiceprint_verify/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export voiceprint_verify to ONNX")
...
def main():
    ...
    # TODO: replace with real ECAPA-TDNN/d-vector model class
