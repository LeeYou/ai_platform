"""Export text_segment (文本分词) model to ONNX format.

Usage:
    python export.py --output /workspace/models/text_segment/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export text_segment to ONNX")
...
def main():
    ...
    # TODO: replace with real Jieba/LTP/BERT-CRF model class
