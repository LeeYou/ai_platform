"""Export crowd_count (人流量统计) model to ONNX format.

Usage:
    python export.py --output /workspace/models/crowd_count/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export crowd_count to ONNX")
...
def main():
    ...
    # TODO: replace with real CSRNet/DM-Count model class
