"""Export content_compliance (内容合规检测) model to ONNX format.

Usage:
    python export.py --output /workspace/models/content_compliance/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export content_compliance to ONNX")
...
def _write_labels_json(output_path: str) -> None:
    data = {"labels": ['compliant', 'non_compliant'], "num_classes": 2}
...
def main():
    ...
    # TODO: replace with real RoBERTa+规则融合 model class
