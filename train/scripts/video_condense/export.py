"""Export video_condense (视频浓缩) model to ONNX format.

Usage:
    python export.py --output /workspace/models/video_condense/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export video_condense to ONNX")
...
def main():
    ...
    # TODO: replace with real 活动检测+关键帧提取 model class
