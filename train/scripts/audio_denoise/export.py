"""Export audio_denoise (语音降噪) model to ONNX format.

Usage:
    python export.py --output /workspace/models/audio_denoise/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export audio_denoise to ONNX")
...
def main():
    ...
    # TODO: replace with real SEGAN/Demucs model class
