"""Export ocr_signature (手写签字OCR) model to ONNX format.

Usage:
    python export.py --output /workspace/models/ocr_signature/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export ocr_signature to ONNX")
...
def _write_preprocess_json(output_path: str) -> None:
    data = {
        "resize": {"width": 320, "height": 64, "keep_ratio": True},
...
def main():
    ...
    # TODO: replace with real TrOCR fine-tuned model class
