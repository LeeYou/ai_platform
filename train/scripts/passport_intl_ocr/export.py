"""Export passport_intl_ocr (国际护照识别（MRZ解析）) model to ONNX format.

Usage:
    python export.py --output /workspace/models/passport_intl_ocr/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export passport_intl_ocr to ONNX")
...
def _write_preprocess_json(output_path: str) -> None:
    data = {
        "resize": {"width": 640, "height": 480, "keep_ratio": True},
...
def main():
    ...
    # TODO: replace with real PP-OCRv4+MRZ parser model class
