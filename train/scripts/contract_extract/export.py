"""Export contract_extract (合同关键信息抽取) model to ONNX format.

Usage:
    python export.py --output /workspace/models/contract_extract/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export contract_extract to ONNX")
...
def main():
    ...
    # TODO: replace with real LayoutLMv3/UIE-contract model class
