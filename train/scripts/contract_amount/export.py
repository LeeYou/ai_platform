"""Export contract_amount (合同额识别) model to ONNX format.

Usage:
    python export.py --output /workspace/models/contract_amount/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export contract_amount to ONNX")
...
def main():
    ...
    # TODO: replace with real BERT+NER model class
