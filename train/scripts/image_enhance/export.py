"""Export image_enhance (图像对比度增强) model to ONNX format.

Usage:
    python export.py --output /workspace/models/image_enhance/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export image_enhance to ONNX")
...
def main():
    ...
    # TODO: replace with real Zero-DCE/RetinexNet model class
