"""Export ocr_business_license (营业执照识别) model to ONNX format.

Usage:
    python export.py --output /workspace/models/ocr_business_license/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export ocr_business_license to ONNX")
