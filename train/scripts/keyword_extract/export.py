"""Export keyword_extract (关键词提取) model to ONNX format.

Usage:
    python export.py --output /workspace/models/keyword_extract/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export keyword_extract to ONNX")
...
def main():
    ...
    # TODO: replace with real TextRank/KeyBERT model class
