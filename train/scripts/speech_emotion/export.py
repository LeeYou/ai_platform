"""Export speech_emotion (语音情绪识别) model to ONNX format.

Usage:
    python export.py --output /workspace/models/speech_emotion/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export speech_emotion to ONNX")
    p.add_argument("--output",     default="/workspace/models/speech_emotion/v1.0.0/")
...
def _write_labels_json(output_path: str) -> None:
    data = {"labels": ['neutral', 'happy', 'sad', 'angry', 'fearful', 'surprised'], "num_classes": 6}
...
def main():
    ...
    # TODO: replace with real HuBERT+分类头 model class
