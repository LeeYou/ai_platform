"""Export liveness_anti_attack (活体防攻击检测) model to ONNX format.

Usage:
    python export.py --output /workspace/models/liveness_anti_attack/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export liveness_anti_attack to ONNX")
...
def _write_labels_json(output_path: str) -> None:
    data = {"labels": ['live', 'print_attack', 'replay_attack', '3d_mask', 'deepfake'], "num_classes": 5}
...
def main():
    ...
    # TODO: replace with real MiniFASNet+多模态融合 model class
