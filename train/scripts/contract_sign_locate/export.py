"""Export contract_sign_locate (合同签名位置识别) model to ONNX format.

Usage:
    python export.py --output /workspace/models/contract_sign_locate/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export contract_sign_locate to ONNX")
...
def _write_labels_json(output_path: str) -> None:
    data = {"labels": ['signature_zone', 'seal_zone'], "num_classes": 2}
