"""Export tts (语音合成（TTS）) model to ONNX format.

Usage:
    python export.py --output /workspace/models/tts/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export tts to ONNX")
...
def main():
    ...
    # TODO: replace with real VITS/FastSpeech2 model class
