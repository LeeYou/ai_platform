"""Export image_super_res (图像超分辨率) model to ONNX format.

Usage:
    python export.py --output /workspace/models/image_super_res/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export image_super_res to ONNX")
...
def main():
    ...
    # TODO: replace with real ESRGAN/Real-ESRGAN model class
