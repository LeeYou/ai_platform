"""Export face_liveness_silent (静默活体检测) model to ONNX format.

Usage:
    python export.py --output /workspace/models/face_liveness_silent/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export face_liveness_silent to ONNX")
...
def _write_labels_json(output_path: str) -> None:
    data = {"labels": ['live', 'spoof'], "num_classes": 2}
...
def main():
    ...
    # TODO: replace with real MobileNetV3/MiniFASNet model class
