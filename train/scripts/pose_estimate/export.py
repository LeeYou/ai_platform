"""Export pose_estimate (人体关键点检测（姿态估计）) model to ONNX format.

Usage:
    python export.py --output /workspace/models/pose_estimate/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export pose_estimate to ONNX")
...
def _write_preprocess_json(output_path: str) -> None:
    data = {
        "resize": {"width": 256, "height": 256, "keep_ratio": True},
...
def main():
    ...
    # TODO: replace with real HRNet-W32/YOLOv8-pose model class
