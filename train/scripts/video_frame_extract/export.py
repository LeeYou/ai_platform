"""Export video_frame_extract (视频帧提取) model to ONNX format.

Usage:
    python export.py --output /workspace/models/video_frame_extract/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export video_frame_extract to ONNX")
...
def main():
    ...
    # TODO: replace with real FFmpeg+质量评估 model class
