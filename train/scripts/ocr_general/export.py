"""Export ocr_general (通用文字识别) model to ONNX format.

Usage:
    python export.py --output /workspace/models/ocr_general/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export ocr_general to ONNX")
...
def main():
    ...
    # TODO: replace with real PaddleOCR/PP-OCRv4 model class
