"""Export ocr_vehicle_license (行驶证识别) model to ONNX format.

Usage:
    python export.py --output /workspace/models/ocr_vehicle_license/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export ocr_vehicle_license to ONNX")
...
def _write_preprocess_json(output_path: str) -> None:
    data = {
        "resize": {"width": 480, "height": 320, "keep_ratio": True},
