"""Export speaker_diarize (说话人分离) model to ONNX format.

Usage:
    python export.py --output /workspace/models/speaker_diarize/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export speaker_diarize to ONNX")
...
def _write_preprocess_json(output_path: str) -> None:
    data = {
        "resize": {"width": 80, "height": 3000, "keep_ratio": True},
...
def main():
    ...
    # TODO: replace with real pyannote.audio/NSD model class
