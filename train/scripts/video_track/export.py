"""Export video_track (视频目标跟踪) model to ONNX format.

Usage:
    python export.py --output /workspace/models/video_track/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export video_track to ONNX")
...
def main():
    ...
    # TODO: replace with real ByteTrack/DeepSORT model class
