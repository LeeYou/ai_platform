"""Export video_tamper_detect (视频篡改检测) model to ONNX format.

Usage:
    python export.py --output /workspace/models/video_tamper_detect/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export video_tamper_detect to ONNX")
...
def _write_labels_json(output_path: str) -> None:
    data = {"labels": ['authentic', 'tampered'], "num_classes": 2}
...
def main():
    ...
    # TODO: replace with real CNN+时序分析 model class
