"""Export id_card_ocr (身份证全字段OCR) model to ONNX format.

Usage:
    python export.py --output /workspace/models/id_card_ocr/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export id_card_ocr to ONNX")
