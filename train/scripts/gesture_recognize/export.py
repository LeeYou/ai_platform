"""Export gesture_recognize (手势识别) model to ONNX format.

Usage:
    python export.py --output /workspace/models/gesture_recognize/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export gesture_recognize to ONNX")
...
def _write_labels_json(output_path: str) -> None:
    data = {"labels": ['ok', 'thumb_up', 'peace', 'fist', 'open_hand', 'point'], "num_classes": 6}
...
def main():
    ...
    # TODO: replace with real MobileNetV3+MediaPipe model class
