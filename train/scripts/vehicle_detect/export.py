"""Export vehicle_detect (车辆检测) model to ONNX format.

Usage:
    python export.py --output /workspace/models/vehicle_detect/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export vehicle_detect to ONNX")
...
def _write_labels_json(output_path: str) -> None:
    data = {"labels": ['car', 'truck', 'bus', 'motorcycle', 'bicycle'], "num_classes": 5}
...
def main():
    ...
    # TODO: replace with real YOLOv8s model class
