"""Export ocr_bank_card (银行卡识别) model to ONNX format.

Usage:
    python export.py --output /workspace/models/ocr_bank_card/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export ocr_bank_card to ONNX")
...
def _write_preprocess_json(output_path: str) -> None:
    data = {
        "resize": {"width": 280, "height": 40, "keep_ratio": True},
...
def main():
    ...
    # TODO: replace with real CRNN+PP-OCRv4 model class
