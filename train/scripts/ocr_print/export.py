"""Export ocr_print (印刷体OCR) model to ONNX format.

Usage:
    python export.py --output /workspace/models/ocr_print/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export ocr_print to ONNX")
...
def main():
    ...
    # TODO: replace with real PP-OCRv4 rec model class
