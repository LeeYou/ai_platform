"""Export ocr_invoice (发票OCR) model to ONNX format.

Usage:
    python export.py --output /workspace/models/ocr_invoice/v1.0.0/ --version 1.0.0
...
def _parse_args():
    p = argparse.ArgumentParser(description="Export ocr_invoice to ONNX")
...
def main():
    ...
    # TODO: replace with real PP-OCRv4+LayoutParser model class
